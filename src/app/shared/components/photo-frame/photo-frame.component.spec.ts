...
describe(PhotoFrameComponent.name, () => {
  ...
  it(`#${PhotoFrameComponent.prototype.like.name} should trigger (@Output liked) once whend called multiple times whitin debounce time`, fakeAsync(() => {
  ...
  it(`#${PhotoFrameComponent.prototype.like.name} should trigger (@Output liked) two times whend called outside debounce time`, fakeAsync(() => {
    fixture.detectChanges();
    let times = 0;
    component.liked.subscribe(() => {
      times++;
